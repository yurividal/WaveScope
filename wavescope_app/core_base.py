...
from .theme import (
    ...
    SIG_FAIR_NM, SIG_WEAK_NM, SIG_POOR_NM,
    GRAPH_BG_DARK, GRAPH_BG_LIGHT,
    GRAPH_AXIS_DARK, GRAPH_AXIS_LIGHT,
    GRAPH_FG_DARK, GRAPH_FG_LIGHT,
    FALLBACK_GRAY,
    ...
    CARD_BG_DARK,
    CARD_VALUE_BG_DARK, CARD_VALUE_BORDER_DARK,
    CARD_VALUE_BG_LIGHT, CARD_VALUE_BORDER_LIGHT,
    BTN_ACCENT, BTN_BORDER, BTN_HOVER_BG,
    BTN_CHECKED_TEXT, BTN_CHECKED_BORDER, BTN_CHECKED_BG,
    SCAN_OVERLAY_BG, SCAN_OVERLAY_HEADING, SCAN_OVERLAY_SUB,
    TABLE_LINGER_FG,
    SEC_BAD, SEC_WPA2, SEC_WPA3, SEC_OTHER, PMF_OPTIONAL,
    VENDOR_MUTED, VENDOR_SUCCESS, VENDOR_ERROR,
    MENU_BG, MENU_BORDER, MENU_TEXT, MENU_SELECTED,
    CONNECTED_GREEN, HTML_MUTED,
    CAPTURE_TITLE_FG,
    CAPTURE_CARD_MON_BG, CAPTURE_CARD_MON_HOVER,
    CAPTURE_CARD_MGD_BG, CAPTURE_CARD_MGD_HOVER,
    CAPTURE_CARD_BORDER, CAPTURE_CARD_TITLE_FG,
    CAPTURE_CARD_SUB_FG, CAPTURE_CARD_BODY_FG,
    CAPTURE_WARN_BG, CAPTURE_WARN_FG, CAPTURE_WARN_BORDER,
    CAPTURE_BTN_START_BG, CAPTURE_BTN_START_FG, CAPTURE_BTN_START_HOVER,
    CAPTURE_BTN_DIS_BG, CAPTURE_BTN_DIS_FG,
    CAPTURE_LOG_BG, CAPTURE_LOG_FG,
    CAPTURE_BTN_STOP_BG, CAPTURE_BTN_STOP_FG, CAPTURE_BTN_STOP_HOVER,
    CAPTURE_BANNER_BG, CAPTURE_BANNER_FG,
    CAPTURE_MGD_STATE_FG, CAPTURE_MGD_LOG_BG, CAPTURE_MGD_LOG_FG,
