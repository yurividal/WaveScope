...
from PyQt6.QtWidgets import (
    ...
    QButtonGroup, QToolButton, QMenu, QScrollArea,
    QDialog, QDialogButtonBox, QProgressBar, QMessageBox, QToolTip
)
from PyQt6.QtCore import (
    Qt, QTimer, QThread, pyqtSignal, QSortFilterProxyModel,
    QAbstractTableModel, QModelIndex, QVariant, QPointF, QRectF,
    QPersistentModelIndex
)
from PyQt6.QtGui import (
    QColor, QFont, QBrush, QPalette, QIcon, QPixmap,
    QPainter, QPen, QLinearGradient, QFontMetrics, QAction, QCursor
)
...
SSID_COLORS = [
    ...
    "#4DB6AC", "#F06292", "#AED581", "#FFD54F", "#4DD0E1",
    "#FF8A65", "#A5D6A7", "#90CAF9", "#FFCC80", "#EF9A9A",
    "#80CBC4", "#9FA8DA", "#F48FB1", "#B0BEC5", "#FFF176",
]
...
_EMBEDDED_OUI: Dict[str, str] = {
    ...
    "00:21:E9": "Apple", "00:23:12": "Apple", "00:23:6C": "Apple",
    "00:25:00": "Apple", "00:25:BC": "Apple", "00:26:B0": "Apple",
    "00:26:BB": "Apple", "04:52:F3": "Apple", "04:4B:ED": "Apple",
    "08:74:02": "Apple", "10:40:F3": "Apple", "18:81:0E": "Apple",
    "20:A2:E4": "Apple", "28:E0:2C": "Apple", "3C:22:FB": "Apple",
    "40:6C:8F": "Apple", "40:D3:2D": "Apple", "44:00:10": "Apple",
    "48:43:7C": "Apple", "54:26:96": "Apple", "60:69:44": "Apple",
    "68:FB:7E": "Apple", "70:CD:60": "Apple", "78:31:C1": "Apple",
    "7C:D1:C3": "Apple", "88:1F:A1": "Apple", "8C:85:90": "Apple",
    "90:3C:92": "Apple", "98:F0:AB": "Apple", "A4:C3:61": "Apple",
    "A8:96:8A": "Apple", "AC:7F:3E": "Apple", "B8:17:C2": "Apple",
    "BC:92:6B": "Apple", "C0:84:7A": "Apple", "C8:2A:14": "Apple",
    "D4:90:9C": "Apple", "DC:86:D8": "Apple", "E4:CE:8F": "Apple",
    "F0:B4:79": "Apple", "F4:37:B7": "Apple",
    # Samsung
    "00:00:F0": "Samsung", "00:12:47": "Samsung", "00:15:99": "Samsung",
    "00:17:D5": "Samsung", "00:1A:8A": "Samsung", "00:1B:98": "Samsung",
    "00:21:19": "Samsung", "00:23:39": "Samsung", "08:08:C2": "Samsung",
    "08:D4:2B": "Samsung", "10:D5:42": "Samsung", "18:22:7E": "Samsung",
    "1C:66:AA": "Samsung", "20:64:32": "Samsung", "24:4B:03": "Samsung",
    "30:19:66": "Samsung", "34:47:90": "Samsung", "38:AA:3C": "Samsung",
    "40:0E:85": "Samsung", "44:4E:1A": "Samsung", "50:F5:20": "Samsung",
    "54:9B:12": "Samsung", "5C:49:79": "Samsung", "60:A1:0A": "Samsung",
    "64:B3:10": "Samsung", "6C:2F:2C": "Samsung", "74:45:8A": "Samsung",
    "78:40:E4": "Samsung", "7C:61:93": "Samsung", "84:25:DB": "Samsung",
    "88:32:9B": "Samsung", "8C:71:F8": "Samsung", "94:51:03": "Samsung",
    "98:52:B1": "Samsung", "9C:3A:AF": "Samsung", "A0:82:1F": "Samsung",
    "A8:06:00": "Samsung", "AC:5A:14": "Samsung", "B0:C4:E7": "Samsung",
    "BC:20:A4": "Samsung", "C0:BD:D1": "Samsung", "CC:07:AB": "Samsung",
    # Intel
    "00:02:B3": "Intel", "00:03:47": "Intel", "00:0C:F1": "Intel",
    "00:0E:35": "Intel", "00:13:02": "Intel", "00:13:20": "Intel",
    "00:13:E8": "Intel", "00:15:00": "Intel", "00:16:EA": "Intel",
    "00:18:DE": "Intel", "00:19:D1": "Intel", "00:1B:21": "Intel",
    "00:1C:BF": "Intel", "00:21:6A": "Intel", "00:21:D8": "Intel",
    ...
    "48:45:20": "Intel", "4C:34:88": "Intel", "54:35:30": "Intel",
    "60:02:B4": "Intel", "60:57:18": "Intel", "68:05:CA": "Intel",
    "6C:88:14": "Intel", "78:92:9C": "Intel", "7C:76:35": "Intel",
    "80:19:34": "Intel", "84:3A:4B": "Intel", "8C:8D:28": "Intel",
    "90:48:9A": "Intel", "94:65:9C": "Intel", "98:4F:EE": "Intel",
    "A0:A8:CD": "Intel", "A4:34:D9": "Intel", "A8:7E:EA": "Intel",
    "AC:37:43": "Intel", "B0:10:41": "Intel", "B4:6B:FC": "Intel",
    "C4:D9:87": "Intel", "C8:5B:76": "Intel", "D0:7E:35": "Intel",
    # TP-Link
    "1C:3B:F3": "TP-Link", "50:C7:BF": "TP-Link", "54:C8:0F": "TP-Link",
    "64:70:02": "TP-Link", "6C:19:8F": "TP-Link", "70:4F:57": "TP-Link",
    "74:DA:38": "TP-Link", "98:DA:C4": "TP-Link", "A0:F3:C1": "TP-Link",
    "AC:84:C6": "TP-Link", "B0:48:7A": "TP-Link", "C4:E9:84": "TP-Link",
    "C8:D3:A3": "TP-Link", "D8:0D:17": "TP-Link", "E4:8D:8C": "TP-Link",
    "E8:DE:27": "TP-Link", "EC:08:6B": "TP-Link", "F4:EC:38": "TP-Link",
    "F8:1A:67": "TP-Link", "10:27:F5": "TP-Link", "18:A6:F7": "TP-Link",
    "24:4B:FE": "TP-Link", "2C:27:D7": "TP-Link", "30:FC:68": "TP-Link",
    "34:60:F9": "TP-Link", "40:3F:8C": "TP-Link", "44:94:FC": "TP-Link",
    "50:3E:AA": "TP-Link", "58:D5:6E": "TP-Link", "5C:89:9A": "TP-Link",
    "60:E3:27": "TP-Link", "68:FF:7B": "TP-Link", "6C:5A:B0": "TP-Link",
    "84:16:F9": "TP-Link", "90:F6:52": "TP-Link", "98:25:4A": "TP-Link",
    "A0:F3:C1": "TP-Link", "B4:B0:24": "TP-Link", "C0:4A:00": "TP-Link",
    # NETGEAR
    ...
    "2C:B0:5D": "NETGEAR", "30:46:9A": "NETGEAR", "6C:B0:CE": "NETGEAR",
    "84:1B:5E": "NETGEAR", "A0:21:B7": "NETGEAR", "A0:40:A0": "NETGEAR",
    "C0:3F:0E": "NETGEAR", "E0:46:9A": "NETGEAR", "10:0C:6B": "NETGEAR",
    "1C:1B:0D": "NETGEAR", "20:E5:2A": "NETGEAR", "2C:30:33": "NETGEAR",
    "30:B5:C2": "NETGEAR", "44:94:FC": "NETGEAR", "6C:4B:90": "NETGEAR",
    "9C:3D:CF": "NETGEAR", "A4:2B:8C": "NETGEAR",
    # ASUS
    "00:0C:6E": "ASUS", "00:0E:A6": "ASUS", "00:11:2F": "ASUS",
    "00:13:D4": "ASUS", "00:15:F2": "ASUS", "00:17:31": "ASUS",
    "00:18:F3": "ASUS", "00:1A:92": "ASUS", "00:1D:60": "ASUS",
    "00:1E:8C": "ASUS", "00:1F:C6": "ASUS", "00:22:15": "ASUS",
    "00:23:54": "ASUS", "00:24:8C": "ASUS", "00:25:22": "ASUS",
    "00:26:18": "ASUS", "10:02:B5": "ASUS", "10:BF:48": "ASUS",
    "14:DA:E9": "ASUS", "1C:87:2C": "ASUS", "2C:56:DC": "ASUS",
    "30:85:A9": "ASUS", "3C:97:0E": "ASUS", "40:16:7E": "ASUS",
    "48:5B:39": "ASUS", "50:46:5D": "ASUS", "54:04:A6": "ASUS",
    "60:45:CB": "ASUS", "6C:72:20": "ASUS", "74:D0:2B": "ASUS",
    "88:D7:F6": "ASUS", "90:E6:BA": "ASUS", "94:DE:80": "ASUS",
    "A8:5E:45": "ASUS", "AC:22:0B": "ASUS", "B0:6E:BF": "ASUS",
    "BC:AE:C5": "ASUS", "C8:60:00": "ASUS", "D0:17:C2": "ASUS",
    "E0:3F:49": "ASUS", "E8:9F:80": "ASUS", "F0:2F:74": "ASUS",
    # D-Link
    ...
    "34:08:04": "D-Link", "5C:D9:98": "D-Link", "6C:72:20": "D-Link",
    "78:54:2E": "D-Link", "84:C9:B2": "D-Link", "90:2B:34": "D-Link",
    "A0:AB:1B": "D-Link", "BC:F6:85": "D-Link", "C8:BE:19": "D-Link",
    # Ubiquiti
    ...
    "00:AA:BB": "Ubiquiti", "24:5A:4C": "Ubiquiti", "60:22:32": "Ubiquiti",
    # Huawei
    "00:18:82": "Huawei", "00:1E:10": "Huawei", "00:22:A1": "Huawei",
    "00:25:9E": "Huawei", "04:25:C5": "Huawei", "04:BD:70": "Huawei",
    "0C:37:DC": "Huawei", "10:1B:54": "Huawei", "14:B9:68": "Huawei",
    "20:08:ED": "Huawei", "20:2B:C1": "Huawei", "20:F3:A3": "Huawei",
    "24:DF:6A": "Huawei", "28:31:52": "Huawei", "2C:AB:00": "Huawei",
    "34:6B:D3": "Huawei", "38:B1:DB": "Huawei", "40:4D:8E": "Huawei",
    "48:00:31": "Huawei", "4C:1F:CC": "Huawei", "54:51:1B": "Huawei",
    "5C:C3:07": "Huawei", "60:DE:44": "Huawei", "64:3E:8C": "Huawei",
    "68:8A:F0": "Huawei", "6C:8D:C1": "Huawei", "70:72:3C": "Huawei",
    # Xiaomi / Mi
    ...
    "64:B4:73": "Xiaomi", "68:DF:DD": "Xiaomi", "74:51:BA": "Xiaomi",
    ...
    "C4:0B:CB": "Xiaomi", "D4:97:0B": "Xiaomi", "F4:8E:08": "Xiaomi",
    # Google
    "F4:F5:D8": "Google", "54:60:09": "Google", "3C:28:6D": "Google",
    "1A:55:A4": "Google", "48:D6:D5": "Google", "20:DF:B9": "Google",
    "DA:E5:F9": "Google", "7C:2E:BD": "Google", "B4:CE:F6": "Google",
    "F0:EF:86": "Google",
    # AVM (FRITZ!Box)
    "00:04:0E": "AVM", "C4:A8:1D": "AVM", "DC:39:6F": "AVM",
    "E4:67:70": "AVM", "9C:C7:A6": "AVM", "00:24:FE": "AVM",
    "3C:A1:0D": "AVM", "5C:49:79": "AVM", "74:31:70": "AVM",
    "A0:24:EC": "AVM", "A8:17:58": "AVM",
    # Linksys
    "00:03:6C": "Linksys", "00:06:25": "Linksys", "00:0C:41": "Linksys",
    ...
    "00:23:69": "Linksys", "00:25:9C": "Linksys", "20:AA:4B": "Linksys",
    "58:6D:8F": "Linksys", "68:7F:74": "Linksys",
    # Eero
    "F8:BB:BF": "Eero", "64:FF:0A": "Eero", "F0:5C:19": "Eero",
    "50:91:E3": "Eero", "6C:19:C0": "Eero",
    # Qualcomm/Atheros (NICs)
    "00:03:7F": "Atheros", "00:05:88": "Atheros",
    # MediaTek/Ralink
    "00:0C:43": "Ralink/MT", "00:21:F7": "Ralink/MT",
    # Realtek
    "00:E0:4C": "Realtek", "52:54:00": "QEMU/VBox",
}
    ...
    def run(self):
        try:
            ...
            req = urllib.request.Request(
                OUI_IEEE_URL,
                headers={"User-Agent": "nmcli-gui-wifi-analyzer/1.0"}
            )
...
class OuiDownloadDialog(QDialog):
    ...
    def __init__(self, parent=None, first_run: bool = True):
        ...
        self._btn_download = btns.addButton("Download", QDialogButtonBox.ButtonRole.AcceptRole)
        self._btn_skip     = btns.addButton(
            "Skip" if first_run else "Close",
...
class AccessPoint:
    ...
    def kvr_flags(self) -> str:
        ...
        flags = []
        if self.rrm: flags.append("k")
        if self.btm: flags.append("v")
        if self.ft:  flags.append("r")
    ...
    for line in output.splitlines():
        ...
        try:
            ...
            aps.append(AccessPoint(
                ssid=ssid, bssid=bssid, mode=mode,
                channel=chan, freq_mhz=freq, rate_mbps=rate,
                signal=signal, security=security,
                wpa_flags=wpa, rsn_flags=rsn,
                bandwidth_mhz=bw, in_use=in_use,
            ))
        except Exception:
            continue
    return aps
...
def parse_iw_scan(output: str) -> Dict[str, dict]:
    ...
    for block in blocks[1:]:
        ...
        if sc_m: d['station_count'] = int(sc_m.group(1))
        if cu_m: d['chan_util']     = int(cu_m.group(1))
        ...
        caps_m = re.search(r'Capabilities:.*?MFP-(capable|required)', text,
                           re.IGNORECASE)
        if caps_m:
            d['pmf'] = 'Required' if 'required' in caps_m.group(1).lower() \
                       else 'Optional'
        else:
            d['pmf'] = 'No'
...
def enrich_with_iw(aps: List[AccessPoint]) -> None:
    ...
    try:
        ...
        for ap in aps:
            ...
            if not d:
                continue
            for attr in ('dbm_exact', 'wifi_gen', 'chan_util', 'station_count',
                         'pmf', 'akm', 'rrm', 'btm', 'ft', 'country'):
                if attr in d:
...
TABLE_HEADERS = [
    "▲", "SSID", "BSSID (MAC)", "Manufacturer", "Band",
    "Ch", "Freq (MHz)", "BW (MHz)", "Signal", "dBm",
    "Rate (Mbps)", "Security", "Mode",
    "Gen", "Ch.Util%", "Clients", "k/v/r",
]
...
class APTableModel(QAbstractTableModel):
    ...
    def data(self, index: QModelIndex, role=Qt.ItemDataRole.DisplayRole):
        ...
        if role == Qt.ItemDataRole.ForegroundRole:
            ...
            if col == COL_UTIL:
                ...
                if pct is not None:
                    if pct >= 75: return QBrush(QColor("#f44336"))
                    if pct >= 50: return QBrush(QColor("#ff9800"))
                    if pct >= 25: return QBrush(QColor("#ffc107"))
        ...
        if role == Qt.ItemDataRole.BackgroundRole:
            ...
            if index.row() % 2 == 1:
                return QApplication.instance().palette().brush(
                    QPalette.ColorRole.AlternateBase)
            return None

        if role == Qt.ItemDataRole.TextAlignmentRole:
            numeric_cols = {COL_CHAN, COL_FREQ, COL_BW, COL_SIG, COL_DBM,
                            COL_RATE, COL_UTIL, COL_CLIENTS}
    ...
    def _display(self, ap: AccessPoint, col: int) -> str:
        if col == COL_INUSE:  return "▲" if ap.in_use else ""
        if col == COL_SSID:   return ap.display_ssid
        if col == COL_BSSID:  return ap.bssid
        if col == COL_MANUF:  return ap.manufacturer
        if col == COL_BAND:   return ap.band
        if col == COL_CHAN:   return str(ap.channel) if ap.channel else "?"
        if col == COL_FREQ:   return str(ap.freq_mhz)
        if col == COL_BW:     return str(ap.bandwidth_mhz)
        if col == COL_SIG:    return f"{ap.signal}%"
        if col == COL_DBM:    return f"{ap.dbm} dBm"
        if col == COL_RATE:   return str(int(ap.rate_mbps))
        if col == COL_SEC:     return ap.security_short
        if col == COL_MODE:    return ap.mode
        if col == COL_GEN:     return ap.wifi_gen or "—"
        if col == COL_UTIL:
            pct = ap.chan_util_pct
            return f"{pct}%" if pct is not None else "—"
        if col == COL_CLIENTS:
            return str(ap.station_count) if ap.station_count is not None else "—"
        if col == COL_KVR:     return ap.kvr_flags
        return ""
...
class APFilterProxy(QSortFilterProxyModel):
    ...
    _COL_NAMES = {
        COL_SSID: "SSID",    COL_BSSID: "MAC",     COL_MANUF: "Vendor",
        COL_BAND: "Band",    COL_CHAN:  "Ch",       COL_SEC:   "Security",
        COL_GEN:  "Gen",     COL_KVR:  "k/v/r",
    }
    ...
    def filterAcceptsRow(self, src_row, src_parent):
        ...
        if self._text_filter:
            haystack = f"{ap.display_ssid} {ap.bssid} {ap.manufacturer} {ap.band}".lower()
    ...
    def lessThan(self, left: QModelIndex, right: QModelIndex) -> bool:
        col = left.column()
        numeric = {COL_CHAN, COL_FREQ, COL_BW, COL_SIG, COL_DBM, COL_RATE,
                   COL_UTIL, COL_CLIENTS}
        lv = self.sourceModel().data(left, Qt.ItemDataRole.DisplayRole)
        rv = self.sourceModel().data(right, Qt.ItemDataRole.DisplayRole)
        if col in numeric:
            try:
                return float(re.sub(r"[^\d.\-]", "", lv or "0")) < \
                       float(re.sub(r"[^\d.\-]", "", rv or "0"))
            except Exception:
                pass
...
def _channel_shape_unit(xs: np.ndarray, fc: float, bw: float) -> np.ndarray:
    ...
    return np.where(in_flat, 1.0,
                    np.where(in_roll, 0.5 * (1.0 + np.cos(np.pi * t)), 0.0))
...
class ChannelGraphWidget(QWidget):
    ...
    def _apply_highlight(self):
        ...
        for bssid, items in self._items.items():
            ...
            c = QColor(color); c.setAlpha(alpha_curve)
            items["curve"].setPen(mkPen(color=c, width=2))
            fc = QColor(color); fc.setAlpha(alpha_fill)
            items["fill"].setBrush(mkBrush(fc))
            items["label"].setColor(QColor(color.red(), color.green(),
                                           color.blue(), alpha_label))
    ...
    def _redraw(self):
        self._items = {}
        visible = [a for a in self._aps
                   if self._band == "All" or a.band == self._band]
        ...
        for band, pw in self._plots.items():
            ...
            for ap in band_aps:
                ...
                bc = QColor(color); bc.setAlpha(55)
                ...
                lf = QFont(); lf.setPointSize(8); lf.setBold(True)
                label.setFont(lf)
                label.setPos(ap.freq_mhz, ap.dbm)
                pw.addItem(label)

                self._items[ap.bssid] = {
                    "color": color, "zero": zero_item,
                    "fill": fill_item, "curve": curve_item, "label": label,
                }
...
class SignalHistoryWidget(QWidget):
    ...
    def __init__(self):
        ...
        self._history: Dict[str, deque] = defaultdict(lambda: deque(maxlen=HISTORY_SECONDS))
...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        _col_widths = {
            COL_INUSE: 26,  COL_SSID: 180, COL_BSSID: 148,
            COL_MANUF: 180, COL_BAND: 72,  COL_CHAN: 44,
            COL_FREQ: 86,   COL_BW: 72,    COL_SIG: 66,
            COL_DBM: 80,    COL_RATE: 94,  COL_SEC: 124,
            COL_MODE: 62,   COL_GEN: 72,   COL_UTIL: 72,
            COL_CLIENTS: 62, COL_KVR: 56,
        }
    ...
    def _apply_theme(self, mode: str):
        ...
        if mode == "dark":
            ...
            plot_bg, plot_fg = ("#0d1117", "#a9b4cc") if is_dark else ("#f0f4f8", "#444455")
    ...
    def _on_pause(self, paused: bool):
        if paused:
            ...
            self._scanner = WiFiScanner(interval_sec=REFRESH_INTERVALS[self._interval_combo.currentIndex()])
            self._scanner.data_ready.connect(self._on_data)
            self._scanner.scan_error.connect(self._on_error)
            self._scanner.start()
...
def _dark_palette() -> QPalette:
    ...
    p.setColor(QPalette.ColorGroup.Disabled, QPalette.ColorRole.ButtonText, C("#4a5068"))
    return p
...
def _light_palette() -> QPalette:
    ...
    p.setColor(QPalette.ColorGroup.Disabled, QPalette.ColorRole.ButtonText, C("#a0a4b0"))
    return p
